module scenes {
   ...
   // Private Instance Variables
    ...
    public _labyrinth: Array<objects.RockBarrier> ;
    ...
    public Start(): void {
      ...
      this._labyrinth = new Array<objects.RockBarrier>();
      this.setLabyrinth2();
      //Players
      ...
      private setLabyrinth2(tp :number = 1):void{
        ...
        switch(tp){
          case 1:
            ...
            labyrinth.push(" ")  
            labyrinth.push(" ")  
            labyrinth.push("  11111111111111111111111    111111111111111111111")  
            labyrinth.push("  1               1              1               1")
            labyrinth.push("  1       1111111         1         1111111111   1")
            labyrinth.push("  1       1               1                1     1")
            labyrinth.push("  11111      11111                   11111   11111")
            labyrinth.push("                   111111111111111                ")
            labyrinth.push("        1                                         ")
            labyrinth.push("  1     11111    111111111111111111111  11111  1  ")
            labyrinth.push("  1              1                   1         1  ")
            labyrinth.push("  1              11111111    111111111         1  ")
            labyrinth.push("  1  1111111111                     1111111     1 ")  
            labyrinth.push("  1         1111111               1111111    111  ")  
            labyrinth.push(" ")
            labyrinth.push("    111111111111111             111111111111111  1")
            labyrinth.push(" 1   1                                           1")
            labyrinth.push(" 1   1111111  1111111  111111       1   ")
            labyrinth.push(" 1   1        1     1  1     1  1        1       1")
            labyrinth.push(" 1  1111111  1     1  1111111  1111111  1111111  1")
            labyrinth.push(" ")
            labyrinth.push("       11111   1   1  1      11111  11111   11   1")  
            labyrinth.push(" 1        1    11111  1          111       11    1")  
            labyrinth.push(" 1111  11111   1   1  1      11111  11111   11   1")  
            labyrinth.push(" 1     1   1   1   1  1      1    111    1       1")  
            labyrinth.push(" 11111 1   1   1111   1111   11111  11111   11   1")  
            //              123456789012345678901234567890123456789012345678
            //                       1         2         3         4
            break;
          case 2:
        ...
        labyrinth.forEach(map =>{
          ...
          for(pos; pos<map.length; pos++){
            if(map.substr(pos,1)=="1"){
              if(Math.random()<=0.8)
                this._labyrinth.push(new objects.RockBarrier(this.assetManager,"rock_barrier", pos_x, pos_y ,true));
              else
                this._labyrinth.push(new objects.RockBarrier(this.assetManager,"rock_barrier_undestructible", pos_x, pos_y ,false));
            }
            pos_x +=tile_width; 
          }
          line_counter++; 
